apps =  {
    ...
    },
    {
      ...
      items: [
        ...
        {icon: 'sports_esports', name:'מבוך התיאורים', type: 'app', appType: 'treasure_maze', listName: 'BIG_VACATION_SIZES', questionIndex: 'english_name', resultIndex: 'picture', setItems: 4, title: 'הקשב למילה ובחר את הדלת הנכונה'},
      ]
    },
  ]
};
