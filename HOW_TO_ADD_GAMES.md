...
| `crystal_arena` | Crystal Arena | Camera game: four answer crystals in the four screen corners. The player holds a saturated coloured object (glove, ball, sticky note) and rests it in the corner of their answer; the game calibrates to that hue once and then tracks it. No model or library. Click/touch/keyboard always work; the camera is optional |
